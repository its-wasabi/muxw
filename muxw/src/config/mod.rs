...
//
//     command: crate::event_loop::EventSender<crate::Token>,
// }
//
...
//             crate::event_loop::EventSender<muxw_types::config::ConfigEvent>,
//         ),
...
//
//         let (event_tx, event_rx) = std::sync::mpsc::channel::<muxw_types::config::ConfigEvent>();
//
